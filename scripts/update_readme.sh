...
sed -i -e "s|https://github.com/Vioneta/vioneta-mini-graph-card/releases/download/.*/mini-graph-card-bundle.js|https://github.com/Vioneta/vioneta-mini-graph-card/releases/download/v${VERSION}/mini-graph-card-bundle.js|g" ./README.md
